...
| --- | --- | ---: | ---: | ---: | ---: |
| `checkpoints/local-eval/tutor-n62-v2` | zero_shot | 50% | 25% | 69% | 16 |
| `checkpoints/local-eval/tutor-n125-v2` | zero_shot | 58% | 75% | 88% | 16 |
| `checkpoints/local-eval/tutor-n250-v2` | zero_shot | 75% | 100% | 88% | 16 |
...
| `checkpoints/local-eval/tutor-n62-v2` | zero_shot | aliasing | 0% | 5 |
...
| `checkpoints/local-eval/tutor-n125-v2` | zero_shot | aliasing | 40% | 5 |
...
| `checkpoints/local-eval/tutor-n250-v2` | zero_shot | aliasing | 80% | 5 |
